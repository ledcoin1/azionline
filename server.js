...
io.on("connection", (socket) => {
  ...
  try {
    ...
    // 🔹 Бос комта іздеу (2 адамға дейін)
    ...
    // 🔹 Егер комта толық (2 адам) → ойын бастау
    if (komta.players.length === 2) {
      ...
      // sendDecisionToCurrentPlayer() бұрынғыдай жұмыс істейді
    }
